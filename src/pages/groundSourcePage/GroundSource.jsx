  ...
  return (
    <div>
      <CommonBanner
        ...
        description={
          "SóGeo delivers energy-efficient, cost-effective geothermal hydronic heating and cooling systems across Melbourne and greater Victoria. Harness the Earth's renewable resources for sustainable comfort in your home or business."
        }
        link={"#"}
        linkText={"Contact Us"}
      />
